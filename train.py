...
# from tensorflow.keras.layers import Input, MaxPooling2D, SeperableConv2D, Flatten
...
parser.add_argument('-c', '--csv_path', default='./all_faces.csv', help='path to save .csv file')
